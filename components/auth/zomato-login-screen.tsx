      ...
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 text-sm leading-relaxed px-4">
            Discover amazing mess services and manage your meals with ease
          </p>
        </div>
          ...
          <CardContent className="p-8">
            <div className="space-y-6">
              ...
              <div className="flex items-center justify-center space-x-2 text-sm text-gray-600 bg-orange-50 rounded-2xl p-3">
                ...
                <span>Find mess services near you</span>
              </div>
              ...
              <Button
                ...
                disabled={isLoading}
                className="w-full h-14 bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white font-semibold rounded-2xl shadow-lg shadow-red-500/25 transition-all duration-200 hover:shadow-xl hover:shadow-red-500/30 hover:scale-[1.02] active:scale-[0.98]"
              >
                {isLoading ? (
