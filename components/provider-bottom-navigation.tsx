...
export function ProviderBottomNavigation({ activeTab = "home" }: ProviderBottomNavigationProps) {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-10 bg-white border-t border-zomato-gray-200 shadow-lg">
        ...
        {tabs.map((tab) => {
          ...
          return (
            <Button
              key={tab.name}
              variant="ghost"
              className={`flex flex-col items-center justify-center w-full h-full bottom-nav-item ${
                isActive 
