    ...
    <div className="pb-20 bg-white">
      ...
      <div className="px-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-green-700">
                    {messData.name} was verified on {messData.verifiedDate}.
                  </p>
                </div>
              </div>
            </CardContent>
            ...
            <div className="grid grid-cols-2 gap-3">
              {messData.plans.map((plan) => (
                <Button
                  key={plan.id}
                  variant="outline"
                  className="h-auto py-4 px-4 flex flex-col items-center justify-center border-red-100 hover:bg-red-50"
                  onClick={() => handleSelectPlan(plan.id)}
                >
                  <span className="font-medium">{plan.name}</span>
                  <span className="text-red-600 mt-1">{plan.price}</span>
                </Button>
              ))}
            </div>

            <div className="mt-4 bg-amber-50 p-4 rounded-lg border border-amber-200 text-amber-800 text-sm">
              <p className="font-bold">⚠️ IMPORTANT NOTICE:</p>
              <p className="mt-1">
                MessCheck is not involved in any payment transactions. Contact mess provider before paying. You are
                fully responsible for your payment.
              </p>
            </div>
          </CardContent>
        </Card>
        ...
        <Dialog open={showPaymentDialog} onOpenChange={setShowPaymentDialog}>
          <DialogContent className="sm:max-w-md">
            <DialogHeader>
              ...
              <DialogDescription>Select a plan and complete payment to subscribe</DialogDescription>
            </DialogHeader>
            ...
            <div className="space-y-4 py-4">
              <div className="grid grid-cols-2 gap-2">
                {messData.plans.map((plan) => (
                  <Button
                    ...
                    className={selectedPlan === plan.id ? "bg-red-600 hover:bg-red-700 text-white" : "border-red-100"}
              ...
              {selectedPlan && (
                <div className="mt-6 space-y-4">
                  <div className="rounded-lg border p-4 border-red-100">
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <div className="flex justify-between font-medium">
                        <span>Amount:</span>
                        <span className="text-red-600">{selectedPlanDetails?.price}</span>
                      </div>
                    </div>

                    <div className="mt-4">
                      <p className="text-sm text-gray-500 mb-2">Pay using UPI:</p>
                      <div className="flex items-center justify-center p-4 bg-gray-50 rounded-lg">
                        <Image src="/qr-code.png" alt="QR Code" width={120} height={120} />
                      </div>
                      <p className="text-center mt-2 font-medium">UPI ID: messcheck@okbank</p>
                    </div>
                  ...
                  <div className="bg-amber-50 p-3 rounded-lg border border-amber-200 text-amber-800 text-sm">
                    ...
                    <p className="mt-1">
                      MessCheck does not handle or guarantee payments. Please contact mess provider before any
                      transaction. Users are responsible for verifying all details.
                    </p>
                  </div>
                </div>
              )}
        ...
        <Dialog open={showShareDialog} onOpenChange={setShowShareDialog}>
          <DialogContent className="sm:max-w-md">
            <DialogHeader>
              ...
              <DialogDescription>Choose how you want to share this mess</DialogDescription>
            </DialogHeader>
            ...
            <div className="space-y-4 py-4">
              <div className="rounded-lg border p-4 border-gray-200">
                ...
                <div className="grid grid-cols-3 gap-3">
                  <a
                    ...
                    className="flex flex-col items-center gap-2 p-3 rounded-lg border border-gray-200 hover:bg-gray-50"
                  >
                  ...
                  <Button
                    variant="outline"
                    className="flex flex-col items-center gap-2 p-3 h-auto border-gray-200 hover:bg-gray-50"
                    onClick={copyShareText}
                  >
                    <div className="bg-red-100 p-2 rounded-full">
                      {copied ? <Check className="h-5 w-5 text-red-600" /> : <Copy className="h-5 w-5 text-red-600" />}
                    </div>
              ...
              <div className="rounded-lg border p-4 border-gray-200">
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">{messData.name}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-500">Address:</span>
                    <span className="font-medium text-right">{messData.address}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-500">Phone:</span>
                    <span className="font-medium">{messData.phone}</span>
                  </div>
                  {messData.coordinates && (
                    <div className="flex justify-between">
                      <span className="text-gray-500">Coordinates:</span>
                      <span className="font-medium">
                        {messData.coordinates.latitude.toFixed(4)}, {messData.coordinates.longitude.toFixed(4)}
                      </span>
                    </div>
                  )}
                </div>
              ...
              <div className="bg-blue-50 p-3 rounded-lg border border-blue-200 text-blue-800 text-sm">
                <p>
                  Sharing this location will help your friends find this mess easily. They can open it in their maps app
                  for directions.
                </p>
              </div>
            </div>
            ...
            <DialogFooter>
              <Button className="w-full bg-red-600 hover:bg-red-700 text-white" onClick={copyShareText}>
        ...
        <Dialog open={showClaimDialog} onOpenChange={setShowClaimDialog}>
          <DialogContent className="sm:max-w-md">
            <DialogHeader>
              <DialogTitle>Claim this Mess</DialogTitle>
              <DialogDescription>Provide your details to claim ownership of {messData.name}</DialogDescription>
            </DialogHeader>
            ...
            <div className="space-y-4 py-4">
              <div className="space-y-2">
                ...
                <input
                  type="email"
                  className="w-full p-2 border rounded-md border-red-100"
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium">Upload Business Proof</label>
                <div className="border-2 border-dashed rounded-md p-4 text-center border-red-100">
                  <p className="text-sm text-gray-500">Upload FSSAI license, GST certificate or other business proof</p>
                  <Button variant="outline" size="sm" className="mt-2 border-red-100">
                    Upload Document
                  </Button>
                </div>
              </div>
              ...
              <div className="bg-blue-50 p-3 rounded-lg border border-blue-200 text-blue-800 text-sm">
                <p>
                  Your claim will be reviewed within 48 hours. Once verified, you'll receive full access to manage your
                  mess profile.
                </p>
              </div>
        ...
        {/* Geolocation Notice */}
        {error && (
          <div className="fixed bottom-16 left-0 right-0 bg-amber-600 text-white p-4 text-center z-40">
